...
def test_validateCell_invalid_board_type():
    sudoku_board = "invalid"  # Invalid board type
    val = 2
    i = 0
    j = 2
    try:
...
def test_validateCell_invalid_value_type():
    sudoku_board = [
        [5, 3, 0, 0, 7, 0, 0, 0, 0],
        [6, 0, 0, 1, 9, 5, 0, 0, 0],
        [0, 9, 8, 0, 0, 0, 0, 6, 0],
    ...
    val = "invalid"  # Invalid value type
    i = 0
    j = 2
    try:
        validateCell(sudoku_board, val, i, j)
...
def test_validateCell_invalid_board_value():
    sudoku_board = [
        [5, 3, 0, 0, 7, 0, 0, 0, 0],
        [6, 0, 0, 1, 9, 5, 0, 0, 0],
        [0, 9, 8, 0, 0, 0, 0, 6, 0],
